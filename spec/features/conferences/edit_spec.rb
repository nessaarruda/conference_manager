...
describe 'Edit Conference page' do
  ...
  it 'updates the attributes of the conference' do
    ...
    fill_in(:name, with: 'World Ruby Convention')
    fill_in(:organization, with: 'Association of Ruby Professionals')
    fill_in(:size, with: 4000)
    fill_in(:start_date, with: "2021-01-19")
    fill_in(:end_date, with: "2021-01-23")
    click_on('Update Conference')
  ...
  it 'allows you to change individual attributes of the conference' do
    ...
    fill_in(:start_date, with: "2021-01-17")
    click_on('Update Conference')
